...
const EXAMPLE_PROMPTS = [
  "Why do I say yes to things I don't want?",
    ...
    screenBody = (
      <div className="min-h-screen bg-[#fff2e6] p-4 sm:p-6">
        ...
        <div ref={contentRef} className="max-w-2xl mx-auto space-y-6 relative">
          {/* Header: Mobile - flush left, Desktop - centered */}
          <div className="text-left sm:text-center mb-2 sm:mb-4 relative">
            <BackToHomePill
              onClick={() => setScreen("HOME")}
              className="absolute top-1/2 right-0 -translate-y-1/2 z-50 !border-2 !border-[#facebb] !text-[#4d4d4d] !rounded-lg text-xs sm:text-sm py-1.5 sm:py-2 px-2 sm:px-3"
            />
            <div className="flex items-center gap-2 sm:justify-center sm:gap-3 pr-[38px] sm:pr-[42px]">
              <img src="/icons/magnifying.svg" alt="" className="h-[50px] w-[50px] sm:h-[86px] sm:w-[86px]" />
              <h1 className="fmy-brand-logotype text-2xl sm:text-4xl font-bold text-gray-900 tracking-tight">FindMyWhy?</h1>
            </div>
          </div>
          
          <FmyCard className="!border-[#facebb]">
            {/* MOBILE: Primary content first (above the fold) */}
            <div className="space-y-5 sm:hidden">
              <div>
                <h2 className="fmy-h2 text-3xl sm:text-5xl leading-none">Describe what's really on your mind</h2>
                <p className="text-base sm:text-lg font-manrope font-light italic text-[#4d4d4d] mt-2">Share something you'd like to explore...</p>
              </div>
            ...
            <div className="flex justify-center sm:hidden mb-6 mt-4">
              <button onClick={handleBegin} disabled={!surfaceQuestion.trim()} className="px-6 py-3 bg-[#3a1fc6] hover:bg-[#3a1fc6]/90 disabled:bg-slate-300 text-white font-manrope font-extrabold rounded-lg transition-colors">
                Begin Deeper Meaning
              </button>
            </div>
            
            {/* MOBILE: Secondary content below (visually subordinate) */}
            <div className="sm:hidden space-y-4 pt-4 border-t border-[#5ba7c1]/30">
              <div>
                <button onClick={() => setShowInfo(!showInfo)} className="flex items-center gap-2 text-[#5ba7c1] hover:text-[#5ba7c1]/80 text-sm font-manrope font-semibold">
                  <HelpCircle size={16} className="text-[#5ba7c1]" />What is Deeper Meaning Mode?
                </button>
                {showInfo && (
              ...
              <div className="space-y-2">
                <p className="text-base font-manrope font-light italic text-[#4d4d4d]">Or try one of these...</p>
                <div className="flex flex-col items-center gap-[11px] mt-3">
                  {EXAMPLE_PROMPTS.map((prompt, i) => (
                    <button key={i} onClick={() => setSurfaceQuestion(prompt)} className="w-full max-w-[280px] px-3 py-1.5 bg-[#facebb]/50 hover:bg-[#facebb]/70 text-[#4d4d4d] text-xs rounded-lg border border-[#facebb] text-center">
                      {prompt}
                    </button>
                  ))}
                </div>
            ...
            <div className="hidden sm:block">
              ...
              <div className="flex justify-center">
                <button onClick={handleBegin} disabled={!surfaceQuestion.trim()} className="px-6 py-3 bg-[#442cd8] hover:bg-[#442cd8]/90 disabled:bg-slate-300 text-white font-manrope font-extrabold rounded-lg flex items-center gap-2 transition-colors">
          ...
          {currentStep === 0 && (
            <p className="text-[10px] font-manrope font-light text-gray-600 text-right mt-2">v70_0d</p>
          )}
        </div>
      </div>
    );
          ...
          <FmyCard className="!border-[#facebb]">
            ...
            <div className="space-y-6 mt-5">
              ...
              <div className="flex justify-center pt-2">
                <button onClick={handleDM1Continue} className="px-6 py-3 bg-[#442cd8] hover:bg-[#442cd8]/90 text-white font-manrope font-extrabold rounded-lg flex items-center gap-2">
            ...
            <div className="space-y-6 mt-5">
              ...
              {dm5Status === 'loading' && (
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
                  <p className="font-manrope font-light text-[#4d4d4d]">Generating...</p>
                </div>
              )}
              ...
              {dm5Status === 'idle' && dm5OutputText && (
                <div className="bg-[#facebb]/20 border-2 border-[#facebb] rounded-xl p-6">
                  <p className="text-xs font-manrope font-light text-[#442cd8] uppercase tracking-wide mb-3">Based on what you shared</p>
                  <div className="text-lg font-manrope font-light text-gray-900 leading-relaxed whitespace-pre-wrap">{dm5OutputText}</div>
                </div>
              )}
              
              {dm5Status === 'idle' && !dm5OutputText && (
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
                  <p className="font-manrope font-light text-[#4d4d4d]">No insight generated yet.</p>
                </div>
              )}
        ...
        <div ref={contentRef} className="max-w-2xl mx-auto space-y-6 relative">
          ...
          <FmyCard>
            ...
            <div className="space-y-6 mt-5">
              ...
              <div className="bg-[#fbe9a3]/30 border border-[#fbe9a3] rounded-lg p-5">
                <div className="flex items-center gap-2 mb-3">
                  <CheckCircle size={18} className="text-[#442cd8]" />
                  <p className="text-sm font-manrope font-extrabold text-[#442cd8]">Exploration Complete</p>
                </div>
              ...
              {dm5OutputText && (
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6">
                  <p className="text-xs font-manrope font-light text-[#4d4d4d] uppercase tracking-wide mb-3">Insight</p>
                  <div className="text-base font-manrope font-light text-[#4d4d4d] leading-relaxed whitespace-pre-wrap">{dm5OutputText}</div>
                </div>
              )}
              
              {/* Closure Recommendation */}
              <div className="bg-white border-2 border-gray-200 rounded-xl p-6">
                <p className="text-xs font-manrope font-light text-[#4d4d4d] uppercase tracking-wide mb-3">Something you might hold lightly:</p>
                <p className="text-base font-manrope font-light text-[#4d4d4d] leading-relaxed">
                  {holdLightlyText}
                </p>
              </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={handleReset} className="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-[#4d4d4d] font-manrope font-extrabold rounded-lg flex items-center gap-2">
                <RotateCcw size={18} /> Start New
              </button>
            </div>
          </div>
          
          <p className="text-center text-xs font-manrope font-light text-[#4d4d4d]">
